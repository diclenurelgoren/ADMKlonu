...
<div class="onlineyazi">EVRAK SORGULAMA</div>
<div class="onlinedivi">
<div class="onliner"></div>
<div class="menumo">
<ul class="menuo">
<li class="aktif2"><a href="online.php">EVRAK SORULAMA</a></li>
<li><a href="belge.php">BELGE DOĞRULAMA</a></li>
</ul>
</div>
</div>
<div class="onlinet">
...
PIN NO:<input type="text" name="pin"  size="50" />
<input type="submit" name="gonder" value="GÖNDER"  />&nbsp;<input type="reset" name="sil" value="SİL" />
